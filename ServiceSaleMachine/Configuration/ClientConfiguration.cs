	...
	public class ClientConfiguration
	{
			...
			try
			{
				...
				if (File.Exists(fileName))
				{
					...
					if (xSettings != null)
					{
                        ...
                        if ((xElement = xSettings.Element("offAdvert")) != null) Settings.offAdvert = int.Parse(xElement.Value);
                        ...
                        if ((xElement = xSettings.Element("numberDevice")) != null) Settings.numberDevice = xElement.Value;
		...
		public bool Save()
		{
			try
			{
                ...
                xSettings.Add(new XElement("offAdvert", Settings.offAdvert.ToString()));
                ...
                xSettings.Add(new XElement("numberDevice", Settings.numberDevice.ToString()));
